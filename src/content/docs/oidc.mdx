...
OIDC_USERNAME_CLAIM=custom_username
...
### OIDC\_USERNAME\_CLAIM

A custom username claim to use instead of the default `preferred_username`. This is useful if your provider uses a different claim for the username, or if you want to use a custom claim that contains the username in a specific format.

See issue [#164](https://github.com/transmute-app/transmute/issues/164) for more details.

### OIDC\_AUTO\_CREATE\_USERS
